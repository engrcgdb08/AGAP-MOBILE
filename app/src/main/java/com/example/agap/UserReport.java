...
public class UserReport extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        storageReference = FirebaseStorage.getInstance().getReference("DisasterReport");
        databaseReference = FirebaseDatabase.getInstance().getReference("DisasterReport");
        ...
        progressDialog = new ProgressDialog(UserReport.this);// context name as per your project name
        ...
        btnupload.setOnClickListener(new View.OnClickListener() {
            ...
            private void UploadImage() {
                ...
                if (FilePathUri != null) {
                    ...
                    storageReference2.putFile(FilePathUri)
                            .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                                ...
                                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                                    ...
                                    Intent intent = new Intent(UserReport.this , DisasterActivity.class);
                    ...
                    Toast.makeText(UserReport.this, "Please Select Image or Add Image Name", Toast.LENGTH_LONG).show();
